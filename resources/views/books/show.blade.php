                        ...
                        <div class="col">
                            ...
                            <div class="d-flex">
                                @if ($book->isBookmarked())
                                    ...
                                    <a href="{{route('bookmark.show', Auth::user()->id)}}" class="btn btn-secondary">
                ...
                <div class="row justify-content-start">
                    <div class="col-8">
                        @foreach ($book->reviews as $review)
                            @if ($review->content !== null || $review->rating !== null)
                                <div class="card mb-4">
                                        ...
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-auto">
                                                @if (Auth::user()->id == $review->user->id)
                                                    <a href="{{route('review.show', ['book_id' => $book->id, 'user_id' => Auth::user()->id])}}" class="btn btn-link btn-sm text-dark">Details</a>
                                                @else
