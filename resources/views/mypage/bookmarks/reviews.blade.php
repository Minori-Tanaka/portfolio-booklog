                        ...
                        <div class="card-body pt-0 pe-0">
                            <div class="d-flex justify-content-end">
                                ...
                                @if ($bookmark->isReviewed($user->id))
                                    <a href="{{route('review.show', ['book_id' => $bookmark->book->id, 'user_id' => $bookmark->user->id])}}" class="mt-1 me-1">
                                        <i class="fa-solid fa-file-lines text-secondary" style="font-size: 1.2em"></i>
                                    </a>
                                @endif
                                {{-- bookmark delete --}}
                                <button class="btn p-0 mt-1" title="Delete Bookmark" data-bs-toggle="modal" data-bs-target="#delete-bookmark-{{$bookmark->book->id}}">
                                    <i class="fa-solid fa-square-minus text-danger" style="font-size: 1.2em"></i>
                                </button>
